 ...
 public void ShowRecord()
    {
        try {
            ...
            if(gendar.getSelectedItem().equals("All"))
            {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("All Principal Records");
        ...
        gendar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Male", "Female" }));
        gendar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gendarActionPerformed(evt);
            }
        });
    ...
    private void gendarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gendarActionPerformed
        ...
        try {
            ...
            if(gendar.getSelectedItem().equals("Male"))
            {
                String quary = "SELECT * FROM principal WHERE gender = 'Male'";
                ResultSet re = stm.executeQuery(quary);
                view.setModel(DbUtils.resultSetToTableModel(re) );

            }
            if(gendar.getSelectedItem().equals("Female"))
            {
                String quary = "SELECT * FROM principal WHERE gender = 'Female'";
                ResultSet re = stm.executeQuery(quary);
                view.setModel(DbUtils.resultSetToTableModel(re) );
    ...
    }//GEN-LAST:event_gendarActionPerformed
